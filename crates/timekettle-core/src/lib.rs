...
pub const PRELOAD_BOOTSTRAP_PROTOCOL_V1: &str = "timekettle.preload-bootstrap/v1";
pub const LD_PRELOAD_ENV_VAR: &str = "LD_PRELOAD";
pub const PRELOAD_PROTOCOL_ENV_VAR: &str = "TIMEKETTLE_PRELOAD_PROTOCOL";
pub const PRELOAD_TRANSPORT_ENV_VAR: &str = "TIMEKETTLE_PRELOAD_TRANSPORT";
pub const PRELOAD_MODE_ENV_VAR: &str = "TIMEKETTLE_PRELOAD_MODE";
pub const PRELOAD_ARTIFACT_ROOT_ENV_VAR: &str = "TIMEKETTLE_PRELOAD_ARTIFACT_ROOT";
pub const PRELOAD_LIBRARY_PATH_ENV_VAR: &str = "TIMEKETTLE_PRELOAD_LIBRARY_PATH";
...
pub enum ArtifactSchemaVersion {
    #[serde(rename = "timekettle.artifact/v1")]
    V1,
}
...
impl ArtifactSchemaVersion {
    pub const fn as_str(self) -> &'static str {
        match self {
            Self::V1 => "timekettle.artifact/v1",
        }
    }
}
...
impl FromStr for ArtifactSchemaVersion {
    ...
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        match value {
            "timekettle.artifact/v1" => Ok(Self::V1),
            _ => Err(()),
        }
    }
}
...
impl ArtifactManifest {
    pub const SCHEMA_VERSION: &'static str = "timekettle.manifest/v1";
}
