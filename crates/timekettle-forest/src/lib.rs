...
pub use timekettle_core::ExecutionGraphNode;
...
/// `timekettle::BoundaryEvent`: the forest crate must not depend on the boundary
...
pub enum FlatReason {
    ...
    /// record-only `timekettle::http_incoming` ingress span asymmetry is a live
