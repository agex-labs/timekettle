...
//! when connected. `TIMEKETTLE_DB_URL` selects the database; the demo scripts boot
//! a dedicated `timekettle-orchestrator-pg` container (see demo/docker-compose.
...
pub const DEFAULT_DB_URL: &str = "postgres://timekettle:timekettle@127.0.0.1:55432/timekettle";
